...
4. **Sweep** — removes the loop's own finished worktrees. A worker whose agent is still going is never removed, and its line names its disposition: `released` or `still counted`.
